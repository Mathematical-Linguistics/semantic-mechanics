...
\titlespacing*{\section}{0pt}{6.5pt plus 2pt minus 1pt}{3pt plus 1pt minus 1pt}
\titlespacing*{\subsection}{0pt}{4.5pt plus 1.5pt minus 1pt}{2pt plus 1pt minus 1pt}

% Headers / Footers
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily\color{darkslate}\textbf{Representational Genealogy}}
...
\end{equation}
where $C_{\text{print}}$ is reproduction and compiler friction, $C_{\text{cog}}$ is visual-cognitive parsing overhead, $C_{\text{coord}}$ is network switching cost across practitioners, and $\mathcal{S}_{\text{inst}}$ is the capital subsidy supplied by sovereign institutions (academies, defense agencies, textbook cartels).
}

When institutional inertia $\mathcal{S}_{\text{inst}}$ dominates, formalisms exhibit \textbf{path-dependent technological lock-in} (Arthur, 1989). A sub-optimal notation can monopolize an entire civilization's intellectual output for centuries, imposing staggering cognitive deadweight loss upon generations of learners.
...
\subsection{Case Study 1: The Calculus Wars---Leibnizian Differentials vs. Newtonian Fluxions}
...
\subsection{Case Study 2: Syntactic Architecture---Chomsky Trees vs. Lambek Pregroups}
...
\begin{itemize}[noitemsep,topsep=2pt]
    ...
    \item \textbf{Lecture 02 (Companion Monograph):} \textit{Cultural Mechanics: Semantic Inversion, Phonetic Proof-of-Work, and High-Performance Cultural Mechanics}. Investigates vernacular autonomy, algebraic sign inversion ($f \mapsto f^{-1}$), multisyllabic rhyme density as proof-of-work, and streaming zero-copy HPC implementations.
\end{itemize}
}

\subsection{The Bridge to Lecture 02: From Institutional Lock-In to Vernacular Inversion}
